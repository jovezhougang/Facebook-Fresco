...
public class ImageUrlsFetcher {
     ...
     * 
     * The rest of this class may be used freely according to the licence file,
     * with the sole exception of this variable. Any fork of this code or use in
     * any other application, whether open- or closed-source, must use a
     * different client ID obtained from Imgur. See the <a
    ...
    public static void getImageUrls(final ImageUrlsRequest request,
        ...
        try {
            ...
            for (int i = 0; i < data.length(); i++) {
                ...
                ImageFormat imageFormat = ImageFormat
                        .getImageFormatForMime(item.getString("type"));
    ...
    @Nullable
    private static String downloadContentAsString(String urlString)
            throws IOException {
        InputStream is = null;
        try {
    ...
    private static String getThumbnailLink(final JSONObject json,
        ...
        return linkBuilder.append(originalUrl).insert(dotPos, imageSize.suffix)
                .toString();
    }
}
